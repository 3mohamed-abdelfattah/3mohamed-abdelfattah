...
[![My Skills](https://skillicons.dev/icons?i=js,kotlin,cpp,java,py,html,css,react,bootstrap,sass,flutter,androidstudio,ktor,idea,androidstudio,atom,vscode,firebase,sqlite,firebase,gradle,git,github,linux,figma&theme=light,blender,ai,pr,postman,stackoverflow,bash,netlify)](https://skillicons.dev)
