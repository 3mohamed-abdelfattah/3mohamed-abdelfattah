...
[![My Skills](https://skillicons.dev/icons?i=js,html,CSS,,idea,kotlin,firebase,sqlite,gradle,cpp,java,react,py,androidstudio,atom,bootstrap,firebase,bash,git,github,ide,ktor,linux,netlify,sass,atom	,vscode,blender,flutter&perline=3,figma&theme=light,ai,pr,flutter,linux,postman,stackoverflow)](https://skillicons.dev)
<br/>
